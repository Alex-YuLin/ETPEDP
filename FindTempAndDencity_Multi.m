...
%{
 待修改項目:
    1.掃描電壓 -3V 更改為 -2V (已修改 BUT 名稱未修改維持n30 ) (已修改)
 未來有可能修改部分
    1.修改脈衝順序 本程式[-5 -2 0.3] 修改為[-5 -2 0 0.3]   (未修改)
%}

% PSPICE 模擬 電流-時間 data
...
for  d=1:dtimes
     Te = TTtmp;
     index=1;
     % Vscan:-2.0V 實際電壓 -> -2V 減-5V的殘壓
     % Vscan: 0.3V 實際電壓 -> 0.3V 減-2V的殘壓
